...
function procesarCompra() {
    ...
    if (compra.obtenerProductosLocalStorage().length === 0) {
        ...
        emailjs.init('9LVIogMJvvP9nRJl6');
        ...
        document.getElementById('procesar-pago')
            .addEventListener('submit', function (event) {
                ...
                const templateID = 'service_53rxgy4';
    ...
    //const nuevo=0;
	//nuevo = this.obtenerProductosLocalStorage().length;
	//localStorage.setItem('Largo', nuevo);
    productosLS=JSON.stringify(productosLS);
    $.post("confirmar.php",{arrayDeValores:productosLS},function(data) {
